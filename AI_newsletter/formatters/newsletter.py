...
def newsletter_gen(todays_date, splash_msg, papers_list, repos_list, news_list):
    """
    ...
    rendered_newsletter = template.render(date=date, splash=splash, papers=papers, news=news, repos=repos)
